...
function Bridal() {
  ...
  const loadData = async () => {
    setServiceList(await serService.getService({ category: 'bridal' }))
  }
  ...
  return (
    <div>
      <h3 className='mb-4'>Bridal Manage</h3>
      <div>
        <div>
          ...
          <Modal title={formState + " Bridal"} open={isModalOpen} onCancel={handleCancel}
            footer={[
