...
function Facial() {
  ...
  const loadData = async () => {
    setServiceList(await serService.getService({ category: 'facial' }))
  }
  ...
  const handleOk = async () => {
    if (formState == "Create") {
      ...
      formData.append('category', "facial");
  ...
  return (
    <div>
      <h3 className='mb-4'>Facial Manage</h3>
      <div>
        <div>
          ...
          <Modal title={formState + " Facial"} open={isModalOpen} onCancel={handleCancel}
            footer={[
