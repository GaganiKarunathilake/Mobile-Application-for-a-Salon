...
function Haircut() {
  ...
  const loadData = async () => {
    setServiceList(await serService.getService({ category: 'haircut' }))
  }
  ...
  return (
    <div>
      <h3 className='mb-4'>Haircut Manage</h3>
      <div>
        <div>
          ...
          <Modal title={formState + " Haircut"} open={isModalOpen} onCancel={handleCancel}
            footer={[
